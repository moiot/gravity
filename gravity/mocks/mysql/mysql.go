...
// Source: github.com/moiot/gravity/gravity/binlog_checker (interfaces: BinlogChecker)
...
import (
	...
	binlog_checker "github.com/moiot/gravity/gravity/binlog_checker"
)
...
// IsBinlogCheckerMsg mocks base method
func (m *MockBinlogChecker) IsBinlogCheckerMsg(arg0, arg1 string) bool {
	ret := m.ctrl.Call(m, "IsBinlogCheckerMsg", arg0, arg1)
	ret0, _ := ret[0].(bool)
	return ret0
}

// IsBinlogCheckerMsg indicates an expected call of IsBinlogCheckerMsg
func (mr *MockBinlogCheckerMockRecorder) IsBinlogCheckerMsg(arg0, arg1 interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IsBinlogCheckerMsg", reflect.TypeOf((*MockBinlogChecker)(nil).IsBinlogCheckerMsg), arg0, arg1)
}
